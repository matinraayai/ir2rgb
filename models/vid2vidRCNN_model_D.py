...
class Vid2VidRCNNModelD(Model):
    ...
    def initialize(self, opt):
        ...
        self.criterionRCNN = networks.RCNNLoss(3)

        self.loss_names = ['G_VGG', 'G_GAN', 'G_GAN_Feat',
                           'D_real', 'D_fake',
                           'G_Warp', 'F_Flow', 'F_Warp', 'W', 'G_RCNN']
    ...
    def forward(self, scale_T, tensors_list, dummy_bs=0):
        ...
        real_B, fake_B, fake_B_raw, real_A, real_B_prev, fake_B_prev, flow, weight, flow_ref, conf_ref, annotation = \
            tensors_list
        ...
        ### RCNN + GAN loss
        loss_G_RCNN = self.criterionRCNN(fake_B, annotation)
        ...
        loss_list = [loss_G_VGG, loss_G_GAN, loss_G_GAN_Feat,
                     ...
                     loss_G_Warp, loss_F_Flow, loss_F_Warp, loss_W, loss_G_RCNN]
        if self.opt.add_face_disc:
